...
appRoot.controller('DSCtrl', function ($scope, $filter) {
    ...
    var init = function () {
        ...
        console.log("in init");
        mediaLibrariesHub = $.connection.mediaLibrariesHub;
    ...
    $scope.DeleteBug = function (b, key) {
        ...
        mediaLibrariesHub.server.deleteBug(b, key);
    ...
    $scope.UpdateBug = function (b, key) {
        ...
        if (b.status == "new") {
            ...
            mediaLibrariesHub.server.updateBug(b, key).done(function () {
                console.log('Success!')
            }).fail(function (e) {
                console.warn(e);
    ...
    $scope.EditBug = function (b, key) {
        ...
        mediaLibrariesHub.server.editNotifyBug(b, key).done(function () {
            console.log('Success!')
        }).fail(function (e) {
            console.warn(e);
    ...
    $scope.CancelBug = function (b, key) {
        ...
        mediaLibrariesHub.server.editAllowBug(b, key).done(function () {
            console.log('Success!')
        }).fail(function (e) {
            console.warn(e);
